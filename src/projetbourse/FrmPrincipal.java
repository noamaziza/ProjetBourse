...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        {
            // for(Action a: t.getLesActions())
            
                 v = new Vector();
                 v.add(t.getIdTrader());
                 v.add(t.getNomTradeur());
                 dtmTraders.addRow(v);
    ...
    private void tblTradersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTradersMouseClicked
        ...
        for( Action a: t.getLesActions() )
        {
             if(t.getIdTrader()==   parseInt(tblTraders.getValueAt(tblTraders.getSelectedRow(),0).toString())  )
             {
                 v = new Vector();
                 v.add(a.getNumAction());
                 v.add(a.getNomAction());
                 v.add(a.getCoursReel());
                 v.add(a.getPrixAchat());
                 v.add(a.getQuantiteAchete());
                 dtmActions.addRow(v); 
                 double sommetotal =( a.getCoursReel()*a.getQuantiteAchete())-(a.getPrixAchat()*a.getQuantiteAchete());
           lblPortefeuille.setText(String.valueOf (sommetotal));
